...
public class Timeline extends JPanel implements MouseListener { //TODO get rid of MouseListener here
    ...
    public int getResume(File dir_images) {
        ...
        files = listFiles(dir_images);
        int largest_int = setImageCount(files);
        
        File dir_trash = CreateProject.getTrashDir();
        files = listFiles(dir_trash);
        int largest_trash = setImageCount(files);
    ...
    public int setImageCount( File[] f ) {
        File lastfile;
        String largestnum;
